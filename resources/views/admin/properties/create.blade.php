                            ...
                            <div class="app_collapse_content d-none">
                                ...
                                <div class="label_g2">
                                    ...
                                    <label class="label">
                                        ...
                                        <input type="tel" name="condominum" class="mask-money" value="{{ old('condominum') }}"/>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="app_collapse">
                            ...
                            <div class="app_collapse_content d-none">
                                ...
                                <label class="label">
                                    ...
                                    <input type="text" name="street" class="street" placeholder="Endereço Completo" value="{{ old('zipcode') }}"/>
                                </label>
