                ...
                <div class="nav_tabs_content">
                    <div id="data">
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="checkbox" name="lessor" {{ (old('lesso') == 'on' || old('lessor') == true ? 'checked' : ($user->lessor == true ? 'checked' : '')) }}><span>Locatário</span>
                            </label>
                                ...
                                <div class="label_g2">
                                    <label class="label">
                                        ...
                                        <input type="tel" name="telephone" class="mask-phone"
                                               placeholder="Número do Telefone com DDD" value="{{ old('telephone') ?? $user->telephone }}"/>
                                    </label>
                                                    ...
                                                    <div class="realty_list_item_content">
                                                        ...
                                                        <div class="realty_list_item_card">
                                                            ...
                                                            <div class="realty_list_item_card_content">
                                                                ...
                                                                <span class="realty_list_item_description_content">{{ $property->bed_rooms +  $property->suites}} Quartos<br><span>Sendo {{ $property->suites }} suítes</span></span>
                                                            </div>
                                                        </div>
